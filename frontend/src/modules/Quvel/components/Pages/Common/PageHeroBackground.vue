...
defineProps({
  ...
  baseOpacity: {
    type: Number,
    default: 0.15, // Very subtle base visibility
  },
  illuminationRadius: {
    type: Number,
    default: 200, // Pixels
  ...
  maxIllumination: {
    type: Number,
    default: 0.6, // Maximum opacity when fully illuminated
  },
  starColor: {
    type: String,
    default: '#ffffff',
...
.SubtleIlluminatedStars {
  ...
  &-IlluminatedLayer {
    ...
    // Create radial illumination effect
  ...
  &-Subtitle {
    @apply tw:text-gray-300 tw:text-lg;
  }
}
</style>
