...
export class SSREndpointConfigService extends SSRService {
  ...
  /**
   * Get the public tenant config endpoint URL.
   * Used by client-side apps to get tenant config by domain.
   */
  getTenantPublicEndpoint(): string {
    return `${this.baseUrl}/${this.tenantPrefix}/public`;
  }
