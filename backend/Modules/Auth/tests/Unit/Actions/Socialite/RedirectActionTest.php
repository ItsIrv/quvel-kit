...
class RedirectActionTest extends TestCase
{
     ...
     */
    public function testStatefulOAuthRedirect(): void
    {
        // Arrange
        $provider = 'google';
     ...
     */
    public function testStatelessOAuthRedirect(): void
    {
        // Arrange
        $provider = 'google';
        $nonce    = 'nonce-value';
     ...
     */
    public function testOAuthRedirectHandlesOAuthException(): void
    {
        // Arrange
        $provider = 'google';
     ...
     */
    public function testOAuthRedirectHandlesGeneralException(): void
    {
        // Arrange
        $provider = 'google';
