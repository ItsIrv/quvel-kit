...
/**
 * Test suite for TenantTableBuilder.
 *
 * @covers \Modules\Tenant\Builders\TenantTableBuilder
 */
class TenantTableBuilderTest extends TestCase
{
     ...
     */
    public function test_after_sets_column_and_returns_fluent_interface(): void
    {
        $builder = TenantTableBuilder::create();
     ...
     */
    public function test_after_with_different_columns(): void
    {
        $testCases = [
            'id',
            'uuid',
     ...
     */
    public function test_cascade_delete_with_default_parameter(): void
    {
        $builder = TenantTableBuilder::create();
     ...
     */
    public function test_cascade_delete_with_explicit_true(): void
    {
        $builder = TenantTableBuilder::create();
     ...
     */
    public function test_cascade_delete_with_false(): void
    {
        $builder = TenantTableBuilder::create();
     ...
     */
    public function test_drop_unique_adds_single_constraint(): void
    {
        $builder = TenantTableBuilder::create();
     ...
     */
    public function test_drop_unique_with_multiple_calls(): void
    {
        $builder = TenantTableBuilder::create();
        $constraint1 = ['email'];
     ...
     */
    public function test_drop_uniques_with_multiple_constraints(): void
    {
        $builder = TenantTableBuilder::create();
        $constraints = [
            ['email'],
     ...
     */
    public function test_drop_uniques_with_empty_array(): void
    {
        $builder = TenantTableBuilder::create();
     ...
     */
    public function test_tenant_unique_adds_single_constraint(): void
    {
        $builder = TenantTableBuilder::create();
        $columns = ['email'];
     ...
     */
    public function test_tenant_unique_with_multiple_calls(): void
    {
        $builder = TenantTableBuilder::create();
        $constraint1 = ['email'];
     ...
     */
    public function test_tenant_uniques_with_multiple_constraints(): void
    {
        $builder = TenantTableBuilder::create();
        $constraints = [
            ['email'],
     ...
     */
    public function test_tenant_uniques_with_empty_array(): void
    {
        $builder = TenantTableBuilder::create();
